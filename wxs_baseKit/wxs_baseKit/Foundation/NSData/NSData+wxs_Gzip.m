...
#import "NSData+wxs_Gzip.h"
#import <zlib.h>
#import <dlfcn.h>

@implementation NSData (wxs_Gzip)

static void *wxs_libzOpen()
{
    static void *libz;
...
{
    if (self.length == 0 || [self wxs_isGzippedData])
    {
        return self;
    }
    
    void *libz = wxs_libzOpen();
...
{
    return [self wxs_gzippedDataWithCompressionLevel:-1.0f];
}
